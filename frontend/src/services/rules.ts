...
export async function getRules(params?: GetRulesParams): Promise<ValidationRule[]> {
...
export async function createRule(data: RuleCreateData): Promise<ValidationRule> {
