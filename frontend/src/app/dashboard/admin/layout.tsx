...
export default function AdminDashboardLayout({
    ...
    const navigation = [
        ...
        { name: "Validation Rules", href: "/dashboard/admin/rules", icon: ClipboardCheck },
        { name: "Quality Reports", href: "/dashboard/admin/reports", icon: FileText },
            ...
            <aside className="hidden lg:flex flex-col w-64 bg-primary text-white shadow-xl transition-all duration-300 z-50">
                <div className="flex items-center gap-3 p-6 border-b border-white/10">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xl font-bold tracking-wide leading-none">DataPulse</span>
                        <span className="text-xs text-accent font-semibold tracking-wider uppercase mt-1">Admin Panel</span>
                    </div>
                </div>
                        ...
                        <div className="hidden sm:flex items-center gap-3 mr-4 border-l border-gray-200 pl-6">
                            <div className="text-right">
                                <div className="flex items-center justify-end gap-2">
                                    ...
                                    <p className="text-sm font-medium text-primary leading-tight">System Admin</p>
                                </div>
                                <p className="text-xs text-gray-500 mt-0.5">admin@amalitech.com</p>
                            </div>
                        ...
                        <aside className="relative flex flex-col w-64 max-w-[80%] h-full bg-primary text-white shadow-2xl animate-in slide-in-from-left">
                            <div className="flex items-center justify-between p-6 border-b border-white/10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-bold text-lg leading-none">DataPulse</span>
                                        <span className="text-[10px] text-accent font-semibold tracking-wider uppercase mt-1">Admin Panel</span>
                                    </div>
                                </div>
