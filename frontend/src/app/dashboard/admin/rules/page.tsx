                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                        <p className="text-sm text-gray-500 font-medium">
                            Showing <span className="text-primary">{paginatedRules.length}</span> of <span className="text-primary">{totalItems}</span> rules
                        </p>
                                ...
                                <div className="space-y-1.5 col-span-2">
                                    ...
                                    <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl space-y-4">
                                        ...
                                        <div className="pt-2 border-t border-gray-200">
                                            <label className="text-[9px] font-bold text-gray-400 uppercase tracking-widest block mb-1">Raw JSON (Preview)</label>
