                  ...
                  {worstDatasets.map((dataset) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-5 text-sm font-semibold text-danger">
                        {dataset.issues.toLocaleString()}
                      </td>
                      <td className="py-3 px-5 text-right">
                        <span
                          className={`inline-flex items-center justify-center px-2.5 py-1 rounded-full text-xs font-bold border ${getScoreColor(dataset.score)}`}
                        >
                          {dataset.score}%
                        </span>
                      </td>
                ...
                {recentActivity.map((activity) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-800">
                      <span className="font-semibold">{activity.user}</span> on{" "}
