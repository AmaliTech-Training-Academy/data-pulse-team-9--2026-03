...
export default function UserDashboardLayout({
    ...
    const navigation = [
        ...
        { name: "Validation Rules", href: "/dashboard/user/rules", icon: ClipboardCheck },
        { name: "Quality Reports", href: "/dashboard/user/reports", icon: FileText },
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden sm:flex items-center gap-3 mr-4">
                            <div className="text-right">
                                <p className="text-sm font-medium text-primary leading-tight">Sarah Designer</p>
